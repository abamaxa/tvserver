...
// Preserve the requested range: clients may treat a shortened response as EOF.
// ServeDir streams the response in bounded buffers, even for ranges extending to EOF.
